...
<nav class="bg-light-primary border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-dark-primary">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    ...
    <div class="w-full md:block md:w-auto" :class="{hidden : showMobileMenu}" id="navbar-default">
      <ul class="flex flex-col p-4 mt-4 border border-light-tail-500 dark:border-dark-navy-100 rounded-lg bg-light-secondary md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-dark-secondary">
        <li>
