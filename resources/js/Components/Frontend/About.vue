        ...
        <div class="container mx-auto">
            ...
            <div class="flex flex-col items-center text-center lg:items-start lg:text-left">
                <div class="flex flex-col">
                    ...
                    <p class="mb-8  text-light-tail-100">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime necessitatibus quia voluptate dicta? Excepturi corrupti aut laborum accusamus necessitatibus harum! <br>
                        <br>
                        Voluptatum cupiditate perspiciatis soluta sint iusto, quidem vel reiciendis numquam illo eligendi dolor molestias tempora quasi neque odio debitis at, delectus alias.
                    </p>
                </div>
                <a href="#contact" class="btn btn-md btn-accent text-light-tail-100">
                Contact me
            </a>
              </div>
        </div>
