        ...
        <div class="w-full px-4 lg:w-1/2">
          <div class="flex flex-wrap lg:justify-end">
            <a
              ...
              class="my-1 inline-block rounded-md  py-4 px-6 text-base border border-transparent font-medium bg-light-tail-500 hover:bg-opacity-90 md:px-9 lg:px-6 xl:px-9 hover:bg-light-primary dark:hover:bg-light-secondary text-dark-primary dark:bg-light-tail-100"
            >
              Start Free Trial
            </a>
          </div>
