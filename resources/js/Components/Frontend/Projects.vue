   ...
   <nav class="mb-12 border-b-2 border-light-tail-100 dark:text-dark-navy-100">
    <ul class="flex flex-col lg:flex-row justify-evenly items-center">
        <li class="cursor-pointer capitalize m-4">
           ...
           class="flex text-center px-4 py-2 hover:text-light-tail-500 dark:text-dark-navy-500"
         ...
         <li class="cursor-pointer capitalize m-4"  v-for="projectSkill in skills" :key="projectSkill.id">
            ...
            class="flex text-center px-4 py-2 hover:text-light-tail-100 dark:text-dark-navy-500">{{ projectSkill.name }}</button> 
        </li> 
